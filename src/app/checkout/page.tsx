...
export default function CheckoutPage() {
  ...
  // Render the checkout UI only on the client. This avoids the Razorpay
  // <Script> / window references being involved in SSR/prerender or hydration,
  ...
  // Until mounted on the client, render nothing (fully client-side only).
