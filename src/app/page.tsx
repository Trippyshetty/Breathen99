    ...
    <>
      ...
      <section id="contact">
        <div className="contact-inner">
          ...
          <div className="contact-col">
            <h4>Contact Us</h4>
            <a href="mailto:info@breathen99.com">info@breathen99.com</a>
      ...
      <footer>
        <div className="footer-links">
          <a href="#faq">FAQ</a>
          <a href="mailto:info@breathen99.com">Contact</a>
      ...
      <div className="float-cta">
        ...
        <a href="mailto:info@breathen99.com" className="float-btn email" title="Email us" aria-label="Email breathEN">
        ...
        <a href="https://wa.me/919819250202" target="_blank" rel="noopener" className="float-btn whatsapp" title="WhatsApp us" aria-label="WhatsApp breathEN">
